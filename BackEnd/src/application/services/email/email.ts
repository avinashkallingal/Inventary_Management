...
export const sendEmailVerification = async (to: string,id:string): Promise<void> => {

console.log(to,id," sendEmailVerification values in function"); 
    const verificationLink = `${process.env.FRONTEND_URL}/email?id=${id}`;
    const mailOptions = {
        from: config.EMAIL,
        to: to,
        ...
        <body>
            ...
            <div class="container">
                ...
                <div class="email-body">
                    ...
                    <a target="_blank" href="${verificationLink}" class="verify-button" style='color:white'>Verify Email</a>
        ...
        <body>
            ...
            <div class="container">
                ...
                <div class="email-body">
                    ...
                    <a target="_blank" href="${verificationLink}" class="reset-button" style='color:white'>Reset Password</a>
